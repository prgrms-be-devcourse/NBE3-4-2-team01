              ...
              <Table>
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>{bookingDetails.bookingId}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">호텔 이름</TableCell>
                    <TableCell>{bookingDetails.hotel.hotelName}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">호텔 이메일</TableCell>
                    <TableCell>{bookingDetails.hotel.hotelEmail}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">호텔 연락처</TableCell>
                    <TableCell>{bookingDetails.hotel.hotelPhoneNumber}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">투숙객 이름</TableCell>
                    <TableCell>{bookingDetails.member.memberName}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">투숙객 이메일</TableCell>
                    <TableCell>{bookingDetails.member.memberEmail}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">객실 유형</TableCell>
                    <TableCell>{bookingDetails.room.roomName}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">객실 번호</TableCell>
                    <TableCell>{bookingDetails.room.roomNumber}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">예약 번호</TableCell>
                    <TableCell>{bookingDetails.bookNumber}</TableCell>
                  </TableRow>
                  <TableRow>
              ...
              <Table>
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>
                      {bookingDetails.createdAt.substring(0, 10)} {bookingDetails.createdAt.substring(11, 16)}
                    </TableCell>
                  </TableRow>
                  <TableRow>
              ...
              <Table>
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>{bookingDetails.payment.paymentId}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">거래 UID</TableCell>
                    <TableCell>{bookingDetails.payment.merchantUid}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">결제 금액</TableCell>
                    <TableCell>{bookingDetails.payment.amount.toLocaleString()}원</TableCell>
                  </TableRow>
                  <TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      {bookingDetails.payment.paidAt.substring(0, 10)} {bookingDetails.payment.paidAt.substring(11, 16)}
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
