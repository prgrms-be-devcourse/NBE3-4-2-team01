                ...
                <Table>
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="text-right">{bookingDetails.bookingId}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">호텔 이름</TableCell>
                      <TableCell className="text-right">{bookingDetails.hotel.hotelName}</TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-right">{bookingDetails.member.memberName}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">투숙객 이메일</TableCell>
                      <TableCell className="text-right">{bookingDetails.member.memberEmail}</TableCell>
                    </TableRow>
                    <TableRow>
                ...
                <Table>
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-right">{bookingDetails.checkInDate}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">체크아웃 날짜</TableCell>
                      <TableCell className="text-right">{bookingDetails.checkOutDate}</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </CardContent>
                ...
                <Table>
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="text-right">{bookingDetails.payment.paymentId}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">거래 UID</TableCell>
                      <TableCell className="text-right">{bookingDetails.payment.merchantUid}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">결제 금액</TableCell>
                      <TableCell className="text-right">{bookingDetails.payment.amount.toLocaleString()}원</TableCell>
                    </TableRow>
                    <TableRow>
