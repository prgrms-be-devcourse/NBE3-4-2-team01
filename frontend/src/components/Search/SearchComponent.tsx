...
import { DatePickerWithRange, DatePickerWithRangeRef } from '@/components/ui/date-range-picker';
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="location-search relative flex-1">
            ...
            <Input
              ...
              className={`pl-10 ${location ? 'bg-gray-100' : ''} ${errors?.location ? 'border-red-500' : ''}`}
            />
            {errors?.location && (
          ...
          <div className="flex-1 relative">
            ...
            <DatePickerWithRange 
              ...
              className={`pl-10 ${selectedRange.start && selectedRange.end ? 'bg-gray-100' : ''}`}
            />
            {errors?.date && (
